...
// Page to translate textfield input into Spanish using a free Google Translate API for Dart
...
class _SpanishPageState extends State<SpanishPage> {
  ...
  // Translate sets textfield value into input which then gets translated to Spanish
  void translate() {
    input = inputController.text;
    translator.translate(input, to: "es").then((Translation output) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return pageScaffold('Spanish', translatedText, translate, input, context, inputController);
  }
}
